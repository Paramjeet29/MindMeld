...
import { faTextWidth, faUpload } from '@fortawesome/free-solid-svg-icons';
export const MyblogDetails = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-3 px-4 lg:px-0 selection:bg-orange-400">
      <div className="w-full flex px-0 lg:w-[50%] mb-2">
        <div className="w-full">
        <button
        onClick={handleBackClick}
            type="button"
            className="bg-orange-200 text-center w-36 rounded-2xl h-8 relative font-sans text-black text-xl font-semibold group"
          >
            <div
              className="bg-orange-400 rounded-xl h-6 w-[20%] flex items-center justify-center absolute left-1 top-[4px] group-hover:w-[136px] z-10 duration-500"
            >
              <svg
                width="25px"
                height="25px"
        ...
        <div className="w-full relative justify-end items-center flex space-x-4">
      ...
      <div className="flex w-full items-center justify-center selection:bg-orange-400">
        <div className="lg:w-[50%] lg:px-0 w-full flex flex-col items-start">
          <h1 className="text-2xl font-bold w-full break-words selection:bg-orange-400">{blogDetails.title}</h1>
          ...
          <p className="mt-4 w-full break-words whitespace-pre-wrap selection:bg-orange-400">{showFullContent ? blogDetails.content : 
