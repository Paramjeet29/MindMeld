  ...
  return (
    <div className="flex flex-col space-y-4 justify-center items-center mt-10 selection:bg-orange-300">
      <div className='w-full px-12 md:px-0 md:w-[45%] flex flex-col'>
        ...
        <input required className="focus:outline-none border border-yellow-900 w-full h-10 focus:ring-1 focus:ring-orange-900 focus:border-orange-900 font-mono py-1 px-2 bg-orange-100 text-yellow-900 placeholder-yellow-900" ref={nameRef} type='text' placeholder="Your name" defaultValue={user?.name}></input>
      </div>
      <div className='w-full px-12 md:px-0 md:w-[45%] flex flex-col'>
        <label className="block font-semibold text-lg">Enter your Email</label>
        <input required className="focus:outline-none border border-yellow-900 w-full h-10 focus:ring-1 focus:ring-orange-900 font-mono py-1 px-2 bg-orange-100 text-yellow-900 placeholder-yellow-900  focus:border-orange-900" ref={emailRef} type='email' placeholder="Your email" defaultValue={user?.email}></input>
      </div>
      ...
      <div className='flex w-full px-12 md:px-0 md:w-[45%] flex-col'>
        ...
        <textarea className="scrollbar-track-rounded-full scrollbar scrollbar-thumb-orange-300 scrollbar-thumb-rounded-3xl scrollbar-track-orange-200 h-28 md:h-32 focus:outline-none border border-yellow-900 w-full focus:ring-1 focus:ring-orange-900 focus:border-orange-900 font-mono py-1 px-2 bg-orange-100 text-yellow-900 placeholder-yellow-900" ref={feedbackRef} placeholder="Feedback"></textarea>
      </div>
