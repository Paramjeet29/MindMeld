  ...
  const renderBlogSection = (title: string, posts: BlogData[], ref: React.RefObject<HTMLDivElement>, handleViewAll: () => void) => (
    <div className="w-full px-2 mb-4 relative">
      ...
      <div className="relative">
        ...
        >
          {posts.map((post) => (
            <div key={post.id} className="hover:cursor-pointer flex-none w-[280px] sm:w-[290px] h-[220px] sm:h-[250px] mx-2" onClick={() => handleBlogClick(post.id)}>
