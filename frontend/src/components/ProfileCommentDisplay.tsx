...
//       <div className="flex shadow-lg px-4 py-2 w-full  justify-start items-center">
//         <span
...
//             <span className='font-semibold uppercase'>{comments.user.name}</span>
...
//             </span>
//           </div>
//           <p className='font-light text-sm'>{comments.content}</p>
//         </div>
//         <button
