...
const ProfileBlogCard: React.FC<BlogcardProps> = ({blog }) => {
  ...
  return (
    ...
    <div className="relative w-[90%]  flex h-auto md:h-[200px]  p-4 mb-2  border-b-2 hover:-translate-y-1  shadow-lg font-mono bg-orange-200 transition-all duration-300 ease-in-out hover:bg-orange-300 hover:shadow-2xl">
