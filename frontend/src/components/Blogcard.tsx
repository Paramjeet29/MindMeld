...
const Blogcard: React.FC<BlogcardProps> = ({ blog }) => {
  return (
    blog.published && (
      <div className="relative p-4 mb-2 h-auto border-b-2 hover:-translate-y-1 rounded-lg shadow-lg font-mono bg-orange-200 transition-all duration-300 ease-in-out hover:bg-orange-300 hover:shadow-2xl">
